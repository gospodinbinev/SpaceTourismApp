...
<div class="container-fluid" style="margin-top: 15px;">
    ...
    {{ Breadcrumbs::render('spacecraft.create') }}
    ...
    <div class="row py-lg-5">
        <div class="col-lg-6 col-md-8 mx-auto">
                ...
                <div class="form-group" style="margin-top: 15px;">
                    ...
                    {!! Form::number('height', old('height'), ['class' => 'form-control '.($errors->has('height') ? 'is-invalid':''), 'step' => 'any']) !!}
                ...
                <div class="form-group" style="margin-top: 15px;">
                    ...
                    {!! Form::number('diameter', old('diameter'), ['class' => 'form-control '.($errors->has('diameter') ? 'is-invalid':''), 'step' => 'any']) !!}
